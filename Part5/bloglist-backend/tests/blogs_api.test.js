...
describe('blogs api with initial blogs', () => {
  ...
  describe('adding blogs', () => {
    test('a valid blog can be added', async () => {
      ...
      const userAfter = (await helper.usersInDb()).find(user => user.id === blogUser._id)
    ...
    test('default likes for added blog', async () => {
      ...
      const addedBlog = blogsAtEnd.find(blog => blog.title === 'Spy techniques: new and slightly old')
  ...
  describe('deleting blogs', () => {
    test('a blog can be deleted', async () => {
      ...
      const blogUser = helper.usersList.find(user => user._id ===
